    ...
    <div class="relative max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-8 animate-fade-in-up">
            ...
            <p class="text-xl text-slate-400 max-w-lg">
                Deja de estudiar a ciegas. Entrena con inteligencia artificial que detecta tus debilidades y las convierte en fortalezas.
            </p>
        ...
        <div class="relative hidden lg:block">
            <div class="relative bg-slate-900/80 backdrop-blur-xl rounded-3xl p-8 border border-slate-700 shadow-2xl">
                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <p class="text-slate-400 text-sm">Progreso promedio estudiantes</p>
                        <p class="text-white text-2xl font-bold">Evolución del puntaje</p>
                    </div>
                    <div class="flex items-center gap-2 px-3 py-1 bg-green-500/20 rounded-full">
                        <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                        <span class="text-green-400 text-sm font-semibold">+110% mejora</span>
                    </div>
                </div>
                ...
                <div class="relative h-64 w-full">
                    <svg class="w-full h-full" viewBox="0 0 400 200" preserveAspectRatio="none">
                        ...
                        <!-- Labels -->
                        <text x="0" y="185" fill="#94a3b8" font-size="12" font-family="sans-serif">Mes 1</text>
                        <text x="180" y="185" fill="#94a3b8" font-size="12" font-family="sans-serif">Mes 2</text>
                        <text x="360" y="185" fill="#94a3b8" font-size="12" font-family="sans-serif">Mes 3</text>
                        
                        <!-- Valeur finale -->
                        <g class="animate-fade-in" style="animation-delay: 2s">
                            <rect x="320" y="10" width="70" height="25" rx="5" fill="#ec4899"/>
                            <text x="355" y="27" fill="white" font-size="12" font-weight="bold" text-anchor="middle">380+</text>
                ...
                <div class="flex items-center justify-center gap-8 mt-6 text-sm">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-400">Estudio tradicional</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-8 h-1 rounded bg-gradient-to-r from-blue-500 to-pink-500"></div>
                        <span class="text-white font-semibold">Con Mente Viva</span>
                    </div>
                </div>
            </div>
...
<section class="py-24 bg-white relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-16">
            <span class="text-red-600 font-semibold text-sm uppercase tracking-wider">La realidad del ICFES</span>
            <h2 class="text-4xl md:text-5xl font-bold text-slate-900 mt-4">
                Cada año, miles de estudiantes <span class="text-red-600">pierden la oportunidad</span> de entrar a la universidad de sus sueños
            </h2>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="group relative bg-slate-50 rounded-2xl p-8 hover:bg-red-50 transition-colors duration-300">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Estudiar sin rumbo</h3>
                <p class="text-slate-600">
                    Pasas horas leyendo guías, pero no sabes qué realmente evalúa el ICFES. <strong class="text-red-600">73% de estudiantes</strong> estudian contenido que no aparece en el examen.
                </p>
            </div>
            ...
            <div class="group relative bg-slate-50 rounded-2xl p-8 hover:bg-orange-50 transition-colors duration-300">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Practicar sin feedback</h3>
                <p class="text-slate-600">
                    Resolver simulacros sin saber <em>por qué</em> fallaste es perder el tiempo. Necesitas corrección inmediata para aprender de tus errores.
                </p>
            </div>
            ...
            <div class="group relative bg-slate-50 rounded-2xl p-8 hover:bg-purple-50 transition-colors duration-300">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-3">Ansiedad el día del examen</h3>
                <p class="text-slate-600">
                    La presión te bloquea porque nunca entrenaste en condiciones reales. El estrés baja tu puntaje hasta <strong class="text-purple-600">40 puntos</strong>.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-6">
        <div class="text-center mb-16">
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-blue-300 text-sm font-medium mb-6">
                ...
                Método validado por 2,500+ estudiantes
            </span>
            <h2 class="text-4xl md:text-6xl font-bold mb-6">
                De "no sé nada" a <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">"estoy listo"</span> en 12 semanas
            </h2>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="relative group">
                ...
                <div class="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-blue-500/50 transition">
                    ...
                    <h3 class="text-2xl font-bold mb-4">Diagnóstico inteligente</h3>
                    <p class="text-slate-400 mb-6">
                        Nuestro algoritmo analiza tus respuestas y detecta exactamente qué competencias debes fortalecer.
                    </p>
                    <div class="flex items-center gap-2 text-blue-400 text-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        Reporte personalizado en 5 minutos
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-purple-500/50 transition">
                    ...
                    <h3 class="text-2xl font-bold mb-4">Entrenamiento adaptativo</h3>
                    <p class="text-slate-400 mb-6">
                        Preguntas que se ajustan a tu nivel. Si dominas matemáticas, avanzamos. Si te cuesta lectura, reforzamos.
                    </p>
                    <div class="flex items-center gap-2 text-purple-400 text-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                        +50 preguntas nuevas cada semana
                    </div>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-pink-500/50 transition">
                    ...
                    <h3 class="text-2xl font-bold mb-4">Simulacros reales</h3>
                    <p class="text-slate-400 mb-6">
                        Practica con condiciones idénticas al ICFES: tiempo, presión, formato. Llegarás al examen sin miedo.
                    </p>
                    <div class="flex items-center gap-2 text-pink-400 text-sm">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        8 simulacros tipo ICFES incluidos
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-t border-slate-800">
            <div class="text-center">
                ...
                <div class="text-slate-400 text-sm">puntos promedio de mejora</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-purple-400 mb-2">2,500+</div>
                <div class="text-slate-400 text-sm">estudiantes activos</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-pink-400 mb-2">94%</div>
                <div class="text-slate-400 text-sm">recomiendan Mente Viva</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-green-400 mb-2">12</div>
                <div class="text-slate-400 text-sm">semanas de entrenamiento</div>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-slate-50">
    <div class="max-w-7xl mx-auto px-6">
        <h2 class="text-4xl font-bold text-center text-slate-900 mb-16">
            Historias de estudiantes que <span class="text-blue-600">sí lograron su sueño</span>
        </h2>
...
<section class="py-24 bg-slate-900 text-white relative overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <p class="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
            Cada día que pasa sin entrenar es una oportunidad que pierde tu competencia. Empieza hoy y conviértete en el estudiante que siempre quisiste ser.
        </p>
            ...
            <a href="https://mente-viva.co/empezarya" target="_blank" 
               class="group relative inline-flex items-center justify-center px-12 py-6 text-xl font-bold text-white transition-all duration-200 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-full hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600">
                <span class="relative z-10 flex items-center gap-3">
                    Quiero mejorar mi puntaje ahora
