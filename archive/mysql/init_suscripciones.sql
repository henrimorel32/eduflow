-- ============================================
-- TABLE pour les écoles souscrites (trial 30 jours)
-- ============================================
...
-- ============================================
-- TRADUCTIONS pour la page de souscription
-- ============================================

-- Section: souscription (général)
...
-- Bouton sur la page d'inscription existante
INSERT INTO contenido_web (seccion, clave, valor, idioma) VALUES
