...
# Création du script de déploiement LOCAL vers VPS
local_deploy_script = '''#!/bin/bash
...
with open('/Users/henri/Documents/GitHub/ESchool/deploy-local.sh', 'w') as f:
    f.write(local_deploy_script)

print("✅ Script de déploiement LOCAL créé: deploy-local.sh")
print(f"   Taille: {len(local_deploy_script):,} caractères")
print()
print("UTILISATION:")
print("  ./deploy-local.sh deploy root@monserveur.com")
print("  ./deploy-local.sh sync root@monserveur.com")
print("  ./deploy-local.sh logs root@monserveur.com")
